强烈推荐使用 [Docker](https://www.docker.com/) 无痛部署坚果量化系统！
...
!!! hint "云服务器推荐"
    阿里云香港节点轻量云服务器仅需 24元/月，足以运行坚果量化系统。腾讯云、华为云也有类似产品，购买前可加我微信（terryso）咨询，可获得进一步的折扣优惠。
...
一切就绪，开始构建 Docker 容器，坚果系统将运行于构建的容器内。
