    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_sync_ts', models.BigIntegerField(null=True, verbose_name='订单同步时间戳')),
                ...
                ('stream_key', django_cryptography.fields.encrypt(models.CharField(max_length=300, verbose_name='Websocket消息密钥'))),
